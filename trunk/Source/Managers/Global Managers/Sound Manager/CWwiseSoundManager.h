...
public:
	...
	//			   int object	   - the object id that the sound attaches to
	//
	...
	//				int object     - the object id that the music attaches to
	//
	...
	//
	// Purpose:  Checks the player number and finds out which character set to play
	// the hurt sound for    
	////////////////////////////////////////////////////////////////////////////////
