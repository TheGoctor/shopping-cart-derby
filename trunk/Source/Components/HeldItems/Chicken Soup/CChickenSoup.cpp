...
CChickenSoupComponent* CChickenSoupComponent::CreateChickenSoupComponent(CObject* pObj)
{
...
void CChickenSoupComponent::PlayerCollision(IEvent* /*cEvent*/, IComponent* /*cCenter*/)
{
	//CChickenSoupComponent* pComp = (CChickenSoupComponent*) cCenter;

}
void CChickenSoupComponent::ItemCollision(IEvent* /*cEvent*/, IComponent* /*cCenter*/)
{
