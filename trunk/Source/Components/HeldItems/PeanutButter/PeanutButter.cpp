...
//call backs
void CPeanutButter::Update(IEvent* cEvent, IComponent* cCenter)
{
...
void CPeanutButter::PlayerCollision(IEvent* cEvent, IComponent* cCenter)
{
	CPeanutButter* pComp = (CPeanutButter*)cCenter;
...
void CPeanutButter::PauseUpdateCallback(IEvent*, IComponent* pComp)
{
	// Get the Effect Comp
