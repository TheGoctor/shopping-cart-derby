...
// Header Protection
///////////////////////////////////////////////////////////////////////////////
#ifndef _CJAMHITEFFECTCOMP_H_
#define _CJAMHITEFFECTCOMP_H_
...
///////////////////////////////////////////////////////////////////////////////
// Jam Hit Effect Component Class
///////////////////////////////////////////////////////////////////////////////
class CJamHitEffectComp : public IComponent
{
private:
...
public:
	...
	//			Jam Hit Effect Object and Creating Sub-Effect Objects and
	//			Render Components as well as Binding them to the Parent Player.
	///////////////////////////////////////////////////////////////////////////
	void Init(void);
	...
	// Constructor
	///////////////////////////////////////////////////////////////////////////
	CJamHitEffectComp(CObject* pParentPlayerObj) : m_pParentObj(pParentPlayerObj),
		m_pDownEffect(NULL), m_pDownVFX(NULL), m_pTargetVFX(NULL), m_fStartTimer(0.0f),
		m_fInvDuration(0.0f), m_bActive(false), m_bDead(false)
	{
		// Add to Auto Manager
		GetManager()->Add(this);
	...
	///////////////////////////////////////////////////////////////////////////
		...
		///////////////////////////////////////////////////////////////////////
		static CJamHitEffectComp* CreateJamHitVFXComponent(
			CObject* pPlayerParentObj)
		{
	...
	///////////////////////////////////////////////////////////////////////////////
		...
		//			Component's Jam Hit Effects and Check for end of Effects.
		///////////////////////////////////////////////////////////////////////////
		...
		//			Jam Hit	Effects Component on the Player that did not use it.
		///////////////////////////////////////////////////////////////////////
