...
RC_PEANUTPILE, RC_CS_BUB1, RC_CS_BUB2,
...
RC_CART_SKID_MARKS, RC_SCI_SKIDS, RC_PB_MARKS, RC_CART_SMOKE_EFFECT, RC_SCI_GLOW,
RC_CHARACTER_SHADOW_BLOB,


RC_HELD_ITEM_COLLECTION_EFFECT,
RC_ITEM_EFFECT_GLOW, RC_ITEM_EFFECT_SHINE,
RC_ITEM_EFFECT_STAR, 

RC_ITEM_EFFECT_AGENT_ORANGE, RC_ITEM_EFFECT_GORILLA_MILK, RC_ITEM_EFFECT_CAPTAIN_FLAKEY,
RC_ITEM_EFFECT_PIZZA, RC_ITEM_EFFECT_CAKE, RC_ITEM_EFFECT_CANNED_BEARS,
RC_ITEM_EFFECT_CARROTS, RC_ITEM_EFFECT_SAMMY_SANDWICH, RC_ITEM_EFFECT_SQUID,


RC_BOOST_GLOW_BLUE, RC_BOOST_LIGHTNING, RC_CLOUD_GRAY,
RC_TURKEY_KRACK_SMALL, RC_TURKEY_KRACK_BIG, RC_TURKEY_KRACK,
RC_SNOWFLAKE_EFFECT, RC_SNOWFLAKE_B_EFFECT,
RC_CARROT_EFFECT, RC_NOODLE_EFFECT, RC_CHICKEN, RC_BROTH,
RC_FLOOR_SPLAT, RC_SHLOOP_POPUP, RC_DRIP_LEFT, RC_DRIP_RIGHT,
RC_PEANUT_EFFECT_SPLASH, RC_SQUISH_POPUP,
...
RC_JAM_USE_EFFECT_ROCKET, RC_JAM_USE_EFFECT_JAR,
RC_JAM_HIT_EFFECT_BLOB, RC_JAM_HIT_EFFECT_SPLURCH_POPUP,
RC_DONUT_EFFECT_PUFF, RC_SPLAT_POPUP,
...
MENU_GOALRANKSCREEN		=	AK::EVENTS::PLAY_SFX_MENU_GOALRANKSCREEN,
...
WINSTATE_EXPLOSION		=	AK::EVENTS::PLAY_FX_3D_EXPLOSION,
START_COUNTDOWN			=	AK::EVENTS::PLAY_DX_GAMEPLAY_STARTRACECOUNTDOWN,   

ALL_GOAL_ITEM_COLLECTED =   AK::EVENTS::PLAY_SFX_ITEM_GOALITEM_ALLCOLLECTED,
GOAL_ITEM_DROP			=	AK::EVENTS::PLAY_SFX_ITEM_GOALITEM_DROP,
GOAL_ITEM_PICKUP		=	AK::EVENTS::PLAY_FX_2D_MAGICPICKUP,
ITEM_SPAWN				=	AK::EVENTS::PLAY_FX_3D_LEVER_SWITCH,
ITEM_PICK_UP			=	AK::EVENTS::PLAY_SFX_ITEM_PICKUP, 
ITEM_COLLISION			=	AK::EVENTS::PLAY_SFX_GAMEPLAY_ITEMCOLLISON,
ITEM_CART				=	AK::EVENTS::PLAY_SFX_ITEM_CART,
...
ITEM_CHICKENSOUP_USE	=	AK::EVENTS::PLAY_SFX_ITEM_CHICKENSOUP_USE, 
...
STATUS_INVULNERABLE		=	AK::EVENTS::PLAY_SFX_PLAYER_STATUS_INVULNERABLE,
STATUS_INVULNERABLE_STOP=	AK::EVENTS::STOP_SFX_PLAYER_STATUS_INVULNERABLE,
STATUS_RADARJAM			=	AK::EVENTS::PLAY_SFX_PLAYER_STATUS_RADARJAM_01, 
...
PAUSE_ALL				=	AK::EVENTS::PAUSE_ALL,
RESUME_ALL				=	AK::EVENTS::RESUME_ALL,
STOP_ALL				=	AK::EVENTS::STOP_ALL,
