...
CButtonComponent::CButtonComponent(scd::object* pObj) : m_pObject(pObj), m_pSelectDown(NULL), m_pSelectUp(NULL),
...
int CButtonComponent::CreateButtonComponent(lua_State* pLua)
{
	...
	scd::object* pObj = (scd::object*)lua_topointer(pLua, -9);
...
void CButtonComponent::Load(string textureName, int nTextureDepth, int nPosX, int nPosY)
{
	...
	m_pDisplayObjectButton = scd::objectManager::GetInstance()->CreateObject(szDispObjName);
...
//
///////////////////////////
void CButtonComponent::Update(IEvent* cEvent, scd::base_component* cCenter)
{
...
void CButtonComponent::UpPressed(IEvent* /*cEvent*/, scd::base_component* cCenter)
{
	CButtonComponent* comp = (CButtonComponent*)cCenter;
...
void CButtonComponent::RightPressed(IEvent* /*cEvent*/, scd::base_component* cCenter)
{
	CButtonComponent* comp = (CButtonComponent*)cCenter;
	if(comp->m_bSelected && comp->m_fTimeSinceSelectionEntry > comp->m_fInputCooldown)
	{
...
void CButtonComponent::LeftPressed(IEvent* /*cEvent*/, scd::base_component* cCenter)
{
	CButtonComponent* comp = (CButtonComponent*)cCenter;
	if(comp->m_bSelected && comp->m_fTimeSinceSelectionEntry > comp->m_fInputCooldown)
	{
...
void CButtonComponent::ButtonStateEnable(IEvent* /*cEvent*/, scd::base_component* cCenter)
{
	CButtonComponent* comp = (CButtonComponent*)cCenter;
...
void CButtonComponent::ButtonStateDisable(IEvent* /*cEvent*/, scd::base_component* cCenter)
{
	CButtonComponent* comp = (CButtonComponent*)cCenter;
	//TStateEvent* pEvent = (TStateEvent*)cEvent->GetData();
...
void CButtonComponent::ButtonStateLoad(IEvent* /*cEvent*/, scd::base_component* /*cCenter*/)
{
	//CButtonComponent* comp = (CButtonComponent*)cCenter;
	//TStateEvent* pEvent = (TStateEvent*)cEvent->GetData();
...
void CButtonComponent::ButtonStateInit(IEvent* /*cEvent*/, scd::base_component* cCenter)
{
	CButtonComponent* comp = (CButtonComponent*)cCenter;
	//TStateEvent* pEvent = (TStateEvent*)cEvent->GetData();
...
void CButtonComponent::GameplayUpdate(IEvent* /*cEvent*/, scd::base_component* cCenter)
{
