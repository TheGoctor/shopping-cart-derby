...
class movement : public scd::base_component {
private:
...
public:
  ...
  ///////////////////////////////////////////////////////////////////////////
  inline void SetObject(scd::object* pObj) { m_pObject = pObj; }

  inline scd::object* GetObject() { return m_pObject; }

  inline void SetPlayerNumber(int nNum) { m_nPlayerNumber = nNum; }

  inline int GetPlayerNumber() { return m_nPlayerNumber; }
  inline float GetPlayerSpeed() { return m_fSpeed; }
  ...
  ///////////////////////////////////////////////////////////////////////////
  static void HandleInputAccelerate(IEvent* cEvent,
  ...
  ///////////////////////////////////////////////////////////////////////////
  static void FreezeStatusCallback(IEvent* cEvent,
                                   scd::base_component* cCenter);
  ...
  ///////////////////////////////////////////////////////////////////////////
  static void InvulnerableStatusCallback(IEvent* cEvent,
                                         scd::base_component* cCenter);
  ...
  //					into another player.
  ///////////////////////////////////////////////////////////////////////////
  static void BounceCallbackPlayer(IEvent* cEvent,
                                   scd::base_component* cCenter);
  ...
  ///////////////////////////////////////////////////////////////////////////
  static void BounceCallbackEnvironment(IEvent* cEvent,
                                        scd::base_component* cCenter);
  ...
  //					accelerate
  ///////////////////////////////////////////////////////////////////////////
  static void DisableMovementInput(IEvent* cEvent,
                                   scd::base_component* cCenter);
