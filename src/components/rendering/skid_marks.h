...
// Skid Mark Mesh
class CSkidMarkMesh : public dx_mesh {
private:
  // Parent Frame
...
public:
  ...
  // Constructor
  CSkidMarks(CObject* pParent, ECharacterSet eType)
  ...
  static CSkidMarks*
  CSkidMarks::CreateSkidMarksComponent(CObject* pParent, ECharacterSet eType) {
