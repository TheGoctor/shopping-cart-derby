...
CHeldItemComponent::CHeldItemComponent(scd::object* pObj) : m_pParent(pObj)
{
...
void CHeldItemComponent::Update(IEvent* piEvent, scd::base_component* piComponent)
{
	// Get component
	...
	if(pcHeldItem->m_bSpawned)
	{
		...
		pcHeldItem->m_pParent->GetTransform()->RotateFrame(scd::vector3(0,1,0), fDT* 1.5f);
...
void CHeldItemComponent::HeldItemCollision(IEvent* iEvent, scd::base_component* comp)
{
...
void CHeldItemComponent::HeldItemCollected(IEvent* iEvent, scd::base_component* comp)
{
	THeldItemCollected* tEvent = (THeldItemCollected*)iEvent->GetData();
	CHeldItemComponent* pComp = (CHeldItemComponent*)comp;
...
void CHeldItemComponent::PauseUpdateCallback(IEvent*, scd::base_component* pComp)
{
	// Get the Effect Comp
