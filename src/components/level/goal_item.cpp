...
CGoalItems::CGoalItems(scd::object* pObj) : m_pObject(pObj)
{
...
void CGoalItems::Update(IEvent* piEvent, scd::base_component* piComponent)
{
	...
	pcGoalItem->m_pObject->GetTransform()->RotateFrame(scd::vector3(0,1,0), fDT* 1.5f);
...
void CGoalItems::ShutdownGoalItem(IEvent* /*piEvent*/, scd::base_component* piComponent)
{
	// Get component
	CGoalItems* pcGoalItem = (CGoalItems*)piComponent;
