...
public:
   ...
   *
   * Ins:				IEvent*		-
   *TUpdateStateEvent* scd::base_component*	-	CGoalItems*
   *
   * Outs:
   *
   * Returns:
   ...
   * Accessors
   ****************************************************************/
  inline EGoalItemType GetType() const { return m_eType; }

  inline scd::object* GetParent() const { return m_pObject; }

  inline bool GetIsCollidable() const { return m_bCollidable; }

  inline bool GetIsSpawned() const { return m_bSpawned; }
};
