...
CPickupItemComponent::CPickupItemComponent(scd::object* pObj) : m_pObject(pObj), m_bSpawned(false)
{
}
...
CPickupItemComponent* CPickupItemComponent::CreatePickupItemComponent(scd::object* pObj, scd::vector3 vDirection)
{
...
//
///////////////////////////
void CPickupItemComponent::Update(IEvent* cEvent, scd::base_component* cCenter)
{
...
void CPickupItemComponent::PickupItemCollisionCallback(IEvent* cEvent, scd::base_component* cCenter)
{
...
void CPickupItemComponent::PauseUpdateCallback(IEvent*, scd::base_component* pComp)
{
	// Get the Effect Comp
