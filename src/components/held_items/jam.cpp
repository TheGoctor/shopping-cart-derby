...
CRayJam* CRayJam::CreateRayJamComponent(scd::object* pObj)
{
...
//call backs
void CRayJam::Update(IEvent* cEvent, scd::base_component* cCenter)
{
...
void CRayJam::ReInit(IEvent* /*cEvent*/, scd::base_component* cCenter)
{
	CRayJam* pComp = (CRayJam*)cCenter;
