...
CDonut* CDonut::CreateDonutComponent(scd::object* pObj)
{
...
//call backs
void CDonut::Update(IEvent* cEvent, scd::base_component* cCenter)
{
...
void CDonut::PlayerCollision(IEvent* cEvent, scd::base_component* cCenter)
{
	CDonut* pComp = (CDonut*)cCenter;
	...
	if(pComp->GetIsSpawned() && tEvent->m_pcCollider == pComp->m_pAttachedObject)
	{
		...
		SendImpactEvent("Steal", pComp, tEvent->m_pcCollider, tEvent->m_pCollidedWith, scd::vector3(0.0f, 0.0f, 0.0f));
