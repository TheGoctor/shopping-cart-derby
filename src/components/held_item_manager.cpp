...
void CHeldItemManager::Init(void)
{
	...
	CEventManager::GetInstance()->RegisterEvent("UsePieForward", (scd::base_component*)this, UsePieCallback);
	CEventManager::GetInstance()->RegisterEvent("UseBananaForward", (scd::base_component*)this, UseBananaCallback);
	CEventManager::GetInstance()->RegisterEvent("UseTurkeyForward", (scd::base_component*)this, UseTurkeyCallback);
	CEventManager::GetInstance()->RegisterEvent("UseBoost", (scd::base_component*)this, UseBoostCallback);
	CEventManager::GetInstance()->RegisterEvent("UsePeanutButterForward", (scd::base_component*)this, UsePeanutButterCallback);
	CEventManager::GetInstance()->RegisterEvent("UseSoup", (scd::base_component*)this, UseSoupCallback);
	CEventManager::GetInstance()->RegisterEvent("UseDonut", (scd::base_component*)this, UseDonutCallback);
	
	string szEventName = "ShutdownObjects";
	szEventName += GAMEPLAY_STATE;
	CEventManager::GetInstance()->RegisterEvent(szEventName, (scd::base_component*)this, ShutdownCallback);
}

void CHeldItemManager::UseTurkeyCallback(IEvent* cEvent, scd::base_component* cCenter)
{
	...
	scd::vector3 vMove(tEvent->m_pObject->GetTransform()->GetWorldMatrix()._31,
	...
	scd::vector3 vPosToSpawnAt = tEvent->m_pObject->GetTransform()->GetWorldPosition() + vMove * 2.0f;
...
void CHeldItemManager::UsePieCallback(IEvent* cEvent, scd::base_component* cCenter)
{
	TStatusEffectEvent* tEvent = (TStatusEffectEvent*)cEvent->GetData();
	...
	scd::vector3 vMove(tEvent->m_pObject->GetTransform()->GetWorldMatrix()._31,
		...
		tEvent->m_pObject->GetTransform()->GetWorldMatrix()._33);
	D3DXVec3Normalize(&vMove, &vMove);
	scd::vector3 vSpawnPos = tEvent->m_pObject->GetTransform()->GetWorldPosition() + vMove * 2.0f;
...
void CHeldItemManager::UseBananaCallback(IEvent* cEvent, scd::base_component* cCenter)
{
	TStatusEffectEvent* tEvent = (TStatusEffectEvent*)cEvent->GetData();
	CHeldItemManager* pMe = (CHeldItemManager*)cCenter;
	...
	scd::vector3 vMove(tEvent->m_pObject->GetTransform()->GetWorldMatrix()._31,
		...
		tEvent->m_pObject->GetTransform()->GetWorldMatrix()._33);
	D3DXVec3Normalize(&vMove, &vMove);
	scd::vector3 vSpawnPos = tEvent->m_pObject->GetTransform()->GetWorldPosition() - vMove*1.7f;
	pComp->SetPosition(vSpawnPos);
	
}

void CHeldItemManager::UsePeanutButterCallback(IEvent* cEvent, scd::base_component* cCenter)
{
	TStatusEffectEvent* tEvent = (TStatusEffectEvent*)cEvent->GetData();
	CHeldItemManager* pMe = (CHeldItemManager*)cCenter;
	...
	scd::vector3 vMove(tEvent->m_pObject->GetTransform()->GetWorldMatrix()._31,
		tEvent->m_pObject->GetTransform()->GetWorldMatrix()._32,
		tEvent->m_pObject->GetTransform()->GetWorldMatrix()._33);
	scd::vector3 vSpawnPos = tEvent->m_pObject->GetTransform()->GetWorldPosition() - vMove*3.5f;
	pComp->SetPosition(vSpawnPos);
}

void CHeldItemManager::UseBoostCallback(IEvent* cEvent, scd::base_component* cCenter)
{
	//TStatusEffectEvent* tEvent = (TStatusEffectEvent*)cEvent->GetData();
	CHeldItemManager* pMe = (CHeldItemManager*)cCenter;
...
void CHeldItemManager::UseSoupCallback(IEvent* cEvent, scd::base_component* cCenter)
{
	TStatusEffectEvent* tEvent = (TStatusEffectEvent*)cEvent->GetData();
	CHeldItemManager* pMe = (CHeldItemManager*)cCenter;
...
void CHeldItemManager::UseDonutCallback(IEvent* cEvent, scd::base_component* cCenter)
{
	TStatusEffectEvent* tEvent = (TStatusEffectEvent*)cEvent->GetData();
	CHeldItemManager* pMe = (CHeldItemManager*)cCenter;
...
void CHeldItemManager::UseRayJamCallback(IEvent* cEvent, scd::base_component* cCenter)
{
	//TStatusEffectEvent* tEvent = (TStatusEffectEvent*)cEvent->GetData();
	CHeldItemManager* pMe = (CHeldItemManager*)cCenter;
...
CTurkeyComponent* CHeldItemManager::GetATurkey(scd::vector3 vPos)
{
...
{
	list<CChickenSoupComponent*, scd::allocator<CChickenSoupComponent*>>::iterator iter;
...
CPie* CHeldItemManager::GetAPie(scd::vector3 vPos)
{
	...
	// create this component
	CPie* pComponent = CPie::CreatePieComponent(pObj, scd::vector3(0.0f,0.0f,0.0f));
...
void CHeldItemManager::ShutdownCallback(IEvent* /*cEvent*/, scd::base_component* /*cCenter*/)
{
	CHeldItemManager* me = GetInstance();

	// despawn all the items in the level
	list<CTurkeyComponent*, scd::allocator<CTurkeyComponent*>>::iterator turkeyIter;
	...
	list<CChickenSoupComponent*, scd::allocator<CChickenSoupComponent*>>::iterator ChickenSoupIter;
	...
	list<CPeanutButter*, scd::allocator<CPeanutButter*>>::iterator PeanutButterIter;
