...
CInventoryComponent* CInventoryManager::CreateInventoryComp(scd::object* pParent)
{
...
CInventoryComponent* CInventoryManager::GetInventoryComponent(scd::object* pObj)
{
	list<CInventoryComponent*, scd::allocator<CInventoryComponent*>>::iterator iter;
