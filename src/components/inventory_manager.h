...
private:
	...
	list<CInventoryComponent*, 
		scd::allocator<CInventoryComponent*>> m_cInvComps;	// A list of all the Inventory Components
...
public:
	...
	//
	// Parameters: 
	//		scd::object* pParent - the object this component is attached to
	//
	// Purpose:  
	//		Creates and inits some data for an inventory component
	////////////////////////////////////////////////////////////////////////////////
	static CInventoryComponent* CreateInventoryComp(scd::object* pParent);
	...
	//
	// Parameters: 
	//		scd::object* pObj - the object the desired component is attached to
	//
	// Purpose:  
	//		Finds the first component (if it exists) that is attached to the object
	////////////////////////////////////////////////////////////////////////////////
	CInventoryComponent* GetInventoryComponent(scd::object* pObj);
