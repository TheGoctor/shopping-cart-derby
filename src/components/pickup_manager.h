...
private:
	...
	list<CPickupItemComponent*, 
		scd::allocator<CPickupItemComponent*>> m_cPickupItemComps;	// A list of all the PickupItem Components
...
public:
	...
	void RemoveComponent(scd::object* pObj);

	CPickupItemComponent* GetPickupComp(EGoalItemType eType);

	static void SpawnPickupItem(IEvent* cEvent, scd::base_component* cCenter);
