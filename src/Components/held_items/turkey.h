...
#ifndef __scd_components_turkey_h__
#define __scd_components_turkey_h__
...
public:
  ...
  static turkey* create(scd::object* owner,
                               const scd::vector3& move_direction);
  ...
  void set_collider(CCollideable* collider) {
    _collider = collider;
  }
  ...
  static void on_environment_collision(IEvent* cEvent, scd::base_component* cCenter);
...
#endif // __scd_components_turkey_h__
