...
struct THUDEffect {
  ...
  //			   EHUDEffectType eHUDEType		 - The HUD
  //Effect
  // Type 			   CSpriteComponent* pSpriteComp - The HUD Icon to
  // Use
  //
  ...
  //			   int nCellHeight - The Height of each Cell in the
  // Sheet
  //
  ...
  ///////////////////////////////////////////////////////////////////////////
  TSpriteData
  GetInitSpriteData(EGoalItemType eGIType, EHUDEffectType eHUDEType);
  TSpriteData
  GetInitInvSpriteData(CSpriteComponent* pSpriteComp, EHUDEffectType eHUDEType);
};
...
private:
  ...
  //			Recycle if possible.
  ///////////////////////////////////////////////////////////////////////
  THUDEffect* GetHUDEffect(EGoalItemType eGIType, EHUDEffectType eHUDEType);
  THUDEffect*
  GetInvHUDEffect(CSpriteComponent* pSpriteComp, EHUDEffectType eHUDEType);
...
public:
  ...
  // Constructor
  ///////////////////////////////////////////////////////////////////////////
  CHUDEffectsComp(CObject* pParentObj)
