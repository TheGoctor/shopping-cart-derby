...
namespace scd {
class CPeanutButterVFXComp : public scd::base_component {
private:
  ///////////////////////////////////////////////////////////////////////////
  // Data Members
  ///////////////////////////////////////////////////////////////////////////
...
public:
  ...
  //			Registering for Events, Getting and Transforming PB
  //Emitter 			Objects as well as Binding them to the Parent Animation Object.
  ///////////////////////////////////////////////////////////////////////////
  void Init(void);
  ...
  //			Unregistering for Events and Destroying the Emitter
  //Objects 			upon Destruction of the Parent Object.
  ///////////////////////////////////////////////////////////////////////////
  void Shutdown(void);
  ...
  // Constructor
  ///////////////////////////////////////////////////////////////////////////
  CPeanutButterVFXComp(CObject* pParent, ECharacterSet eType)
  ...
  ///////////////////////////////////////////////////////////////////////
  static CPeanutButterVFXComp*
  CreatePBVFXComponent(CObject* pParent, ECharacterSet eType) {
