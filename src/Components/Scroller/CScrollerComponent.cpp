...
CScrollerComponent::CScrollerComponent(CObject* pObj) : m_pObject(pObj), m_xSize(0.0f), m_ySize(0.0f),
...
{
	CObject* pObj = pButton->GetParent();
...
//
///////////////////////////
void CScrollerComponent::Update(IEvent* cEvent, IComponent* cCenter)
{
...
void CScrollerComponent::ScrollerStateEnable(IEvent* /*cEvent*/, IComponent* /*cCenter*/)
{
	//CScrollerComponent* comp = (CScrollerComponent*)cCenter;
...
void CScrollerComponent::ScrollerStateDisable(IEvent* /*cEvent*/, IComponent* /*cCenter*/)
{
	//CScrollerComponent* comp = (CScrollerComponent*)cCenter;
	//TStateEvent* pEvent = (TStateEvent*)cEvent->GetData();
...
void CScrollerComponent::ScrollerStateInit(IEvent* /*cEvent*/, IComponent* cCenter)
{
	CScrollerComponent* comp = (CScrollerComponent*)cCenter;
	//TStateEvent* pEvent = (TStateEvent*)cEvent->GetData();
