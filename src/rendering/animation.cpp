...
// Interpolate
scd::transform  Interpolator::animInterpolate(scd::transform a, scd::transform b, float fPercent)
{
...
// NON-FUNCTIONAL
scd::transform Interpolator::interpolateWithScale(scd::transform a, scd::transform b, float fPercent)
{
	// Get the Mag of Pos Vecs
	D3DXVECTOR3 vPosA = D3DXVECTOR3(a._41, a._42, a._43);
	D3DXVECTOR3 vPosB = D3DXVECTOR3(b._41, b._42, b._43);
