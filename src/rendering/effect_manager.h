...
typedef map<unsigned int, CParticleEmitter*, less<unsigned int>,
		scd::allocator<pair<unsigned int, CParticleEmitter*>>> EmitterMap;

typedef map<unsigned int, CEffectComponent*, less<unsigned int>,
		scd::allocator<pair<unsigned int, CEffectComponent*>>> EffectCompMap;

typedef map<CObject*, CEffectComponent*, less<CObject*>,
		scd::allocator<pair<CObject*, CEffectComponent*>>> ObjEffectCompMap;

typedef map<unsigned int, CObject*, less<unsigned int>,
		scd::allocator<pair<unsigned int, CObject*>>> ObjMap;
