...
void DXRenderShape::SetVPHelper(DXRenderShape &shapeNode)
{
	...
	// Set MVP
	scd::transform mVP = CCameraManager::GetInstance()->GetCam()->GetViewProjectionMatrix();
...
void DXRenderShape::RenderBonesHelper(DXRenderShape &shapeNode, CFrame & frame, LPD3DXMESH sphere)
{
	...
	list<CFrame*, scd::allocator<CFrame*>>::iterator childIter = frame.GetChildren()->begin();
